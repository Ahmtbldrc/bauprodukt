...
export default function ProviderSelector({ 
  ...
  return (
    <div className="space-y-4">
      <h3 className="text-lg font-medium text-gray-900 mb-4">Zahlungsmethode wählen</h3>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        >
          ...
          <div className="flex items-center gap-2">
            ...
            <img src="/images/apple-pay.svg" alt="Apple Pay" className="h-6" />
            <img src="/images/google-pay.svg" alt="Google Pay" className="h-6" />
          </div>
      ...
      <div className="mt-4 p-4 bg-blue-50 border border-blue-200 rounded-lg">
        <div className="flex items-start gap-3">
          ...
          <div className="text-sm text-blue-800">
            ...
            <p>Nach der Auswahl werden Sie sicher zur Zahlungsseite des Anbieters weitergeleitet. Ihre Zahlungsdaten werden nicht auf unseren Servern gespeichert.</p>
          </div>
        </div>
      </div>
    </div>
