...
export default function CheckoutFailurePage() {
    ...
    switch (code) {
      case 'cancelled':
        return {
          ...
          message: 'Sie haben die Zahlung abgebrochen. Ihre Bestellung wurde nicht abgeschlossen.',
      ...
      case 'failed':
        return {
          ...
          message: 'Die Zahlung konnte nicht verarbeitet werden. Bitte überprüfen Sie Ihre Zahlungsdaten und versuchen Sie es erneut.',
      ...
      case 'expired':
        return {
          ...
          message: 'Die Zahlungssitzung ist abgelaufen. Bitte starten Sie den Zahlungsvorgang erneut.',
      ...
      default:
        return {
          ...
          message: 'Es gab ein Problem bei der Verarbeitung Ihrer Zahlung. Bitte versuchen Sie es erneut.',
          icon: <AlertCircle className="h-8 w-8 text-red-600" />,
          bgColor: 'bg-red-100'
        }
    }
  ...
  const providerName = provider === 'stripe' ? 'Stripe' : 'DataTrans (TWINT)'
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="max-w-2xl mx-auto text-center">
        <div className="mb-8">
          <div className={`w-16 h-16 ${failure.bgColor} rounded-full flex items-center justify-center mx-auto mb-4`}>
            {failure.icon}
          </div>
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-6 mb-6 text-left">
            <h3 className="text-lg font-semibold text-gray-900 mb-4">Lösungsvorschläge</h3>
            <ul className="space-y-2 text-sm text-blue-800">
              {code === 'cancelled' ? (
                <>
                  <li>• Stellen Sie sicher, dass Sie den Zahlungsvorgang abschließen möchten</li>
                  <li>• Überprüfen Sie Ihre Internetverbindung</li>
                  <li>• Versuchen Sie es mit einem anderen Browser</li>
                </>
              ) : (
                <>
                  <li>• Überprüfen Sie Ihre Kartendaten (Nummer, Ablaufdatum, CVC)</li>
                  <li>• Stellen Sie sicher, dass genügend Guthaben verfügbar ist</li>
                  <li>• Versuchen Sie es mit einer anderen Zahlungsmethode</li>
                  <li>• Kontaktieren Sie Ihre Bank, falls das Problem weiterhin besteht</li>
                </>
              )}
            </ul>
          </div>
          ...
          <div className="mt-8 p-4 bg-gray-50 border border-gray-200 rounded-lg">
            <h4 className="font-medium text-gray-900 mb-2">Benötigen Sie Hilfe?</h4>
            <p className="text-sm text-gray-600 mb-3">
              Falls Sie weiterhin Probleme haben, kontaktieren Sie uns gerne.
            </p>
            <div className="flex flex-col sm:flex-row gap-2 justify-center text-sm">
              <span className="text-gray-600">E-Mail: support@bauprodukt.ch</span>
